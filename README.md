...
-I wrote this some years ago, before I knew anything about shaders or the rendering pipeline. I'd write this differently know so it leveraged the gpu a bit more, but the approach I wrote isn't bad for a cpu focused solution.
- It handles texturing pretty quickly. When I was trying to find a suitable approach for a tile-based world that used sprites similar to older 2d rpgs, there werent a lot of solutions I could find at the time. 
